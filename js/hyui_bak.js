$(function() {
    ...
    if (ie) {
        $(".img-container").each(function() {
            ...
            var $container = $(this);
            $container.has('.none').find('a').addClass('ie-object-none');
            $container.has('.none').find('a').css('backgroundImage', 'url(' + imgUrl + ')');
            $container.has('.cover').find('a').addClass('ie-object-cover');
            $container.has('.cover').find('a').css('backgroundImage', 'url(' + imgUrl + ')');
            $container.has('.fill').find('a').addClass('ie-object-fill');
            $container.has('.fill').find('a').css('backgroundImage', 'url(' + imgUrl + ')');
            $container.has('.contain').find('a').addClass('ie-object-contain');
            $container.has('.contain').find('a').css('backgroundImage', 'url(' + imgUrl + ')');
        });
    }
    /*-----------------------------*/
